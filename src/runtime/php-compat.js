 ...
 * to match the API surface expected by the FacturaScripts Playground
 * runtime (bootstrap.js, php-worker.js, addons.js, vfs.js).
 */

import { __private__dont__use } from "@php-wasm/universal";

const DEFAULT_WEB_ROOT = "/www/facturascripts";
 ...
 * expected by the FacturaScripts Playground runtime.
 */
export function wrapPhpInstance(
  ...
  return {
    ...
    async request(requestOrUrl) {
      ...
      // FacturaScripts relies on for clean URLs like /Dashboard, /admin, etc.
      ...
      const serverVars = {
        ...
        HTTP_USER_AGENT: "FacturaScriptsPlayground/1.0 (WASM)",
